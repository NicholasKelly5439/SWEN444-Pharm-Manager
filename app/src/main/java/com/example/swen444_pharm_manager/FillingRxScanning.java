 ...
 * Use the {@link FillingRxScanning#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FillingRxScanning extends Fragment {
     ...
     * @return A new instance of fragment FillingRxScanning.
     */
    // TODO: Rename and change types and number of parameters
    public static FillingRxScanning newInstance(String param1, String param2) {
        FillingRxScanning fragment = new FillingRxScanning();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_filling_rx_scanning, container, false);
    }
        ...
        view.findViewById(R.id.MenuImage).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(FillingRxScanning.this)
                        .navigate(R.id.action_FillingRxScanning_to_FillingCounting);
            }
        });
